package net.TravisC.tutorialmod.block;

import net.TravisC.tutorialmod.TutorialMod;
import net.TravisC.tutorialmod.block.custom.ModFlamableRotatedPillarBlock;
...
public class ModBlocks {
    ...
    /*NOTE: OPAL ORE DROPS EXP USING "UnifromInt" USE MIDDLE CLICK TO SEARCH IMPORT CLASS PROPERTIES
    SUCH AS EXP VALUES*/
